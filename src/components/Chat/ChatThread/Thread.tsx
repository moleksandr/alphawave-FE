...
import Header from "../ChatThread/Header";

import websocket from '../../../utils/websocket';

import ChatReplies from '../ChatMessage/ChatReplies';
...
const ChatMessage = (props: any) => {
    ...
    return (
        <div className="flex-1 bg-white p-4 my-6 mr-3">
            <Header user={user} channel={channel} setThread={setThread} thread={thread} />
            <hr />
            <ChatReplies messages={threads} />
            <br />
            <div className="flex items-center border border-gray-300 rounded-2xl pl-2 bg-bgColorGrey bg-opacity-10">
                ...
                <button
                    ...
                    onClick={(e: FormEvent) => {
                        ...
                        sendMessage(inputElement?.current?.value, root, imageData);
